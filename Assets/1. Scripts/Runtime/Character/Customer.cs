...
public class Customer : FoodHolder, IInteractable
{
    ...
    IEnumerator StandRoutine()
    {
        ...
        // Default Stand Scenario [EN] Standard standing animation [KR] �⺻ �Ͼ�� �ִϸ��̼�
        {
        ...
        {
            while (true)
            // Patience Stand Scenario (Controlled by AnimController) [EN] Wait for angry/wrong animation to finish [KR] �г�/���� �ִϸ��̼��� ���� ������ ���
            {
